...
### Changed
- Renamed from `never-say-never` → `high-agency-mode`. Old aliases (never-say-never, you-can-just-do-things, yes-can-do) are now called out in the plugin description as alternate names for the same idea.
- OG card tagline rebranded to "You can just do things." to match the new framing. Subtitle tightened.
- Launch tweet rewritten around the new name; dogfood story preserved.
