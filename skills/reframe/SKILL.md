---
name: reframe
description: Use when your previous reply reached for "can't" / "cannot" / "can not" — shift from constraint-first framing to high-agency, chief-of-staff problem-solving. Triggered automatically by the no-cant Stop hook; can also be invoked directly on phrases like "reframe this", "find another way", "no, actually solve it".
---
